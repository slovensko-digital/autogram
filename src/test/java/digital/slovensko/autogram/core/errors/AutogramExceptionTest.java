...
class AutogramExceptionTest {
    ...
    void createFromIllegalArgumentExceptionSigningCertificateExpiredMessageTest() {
        Assertions.assertSame(SigningWithExpiredCertificateException.class, AutogramException.fromThrowable(new IllegalArgumentException("The signing certificate (notBefore : 2022-12-29T08:34:56Z, notAfter : 2022-12-30T08:34:56Z) is expired at signing time 2023-05-25T07:35:18Z! Change signing certificate or use method setSignWithExpiredCertificate(true).")).getClass());
    }
}
