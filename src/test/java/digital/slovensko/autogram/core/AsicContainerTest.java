...
class AsicContainerTest {
    ...
    void testGetOriginalFileXdc() {
        ...
        var xdcFileFromAsice = AsicContainerUtils.getOriginalDocuments(asiceWithXdcOriginalFile).get(0);
    ...
    void testGetOriginalFileNoSigantures() {
        ...
        Assertions.assertThrows(OriginalDocumentNotFoundException.class, () -> AsicContainerUtils.getOriginalDocuments(asiceWithoutSignatures).get(0));
    }
    ...
    void testGetOriginalFileNoOriginalFileInAsice() {
        ...
        Assertions.assertThrows(OriginalDocumentNotFoundException.class, () -> AsicContainerUtils.getOriginalDocuments(asiceWithoutOriginalFile).get(0));
    }
    ...
    void testGetOriginalFileNoFileEntriesInManifest() {
        ...
        var originalFile = AsicContainerUtils.getOriginalDocuments(asiceWithManifestFileWithoutFileEntries).get(0);
    ...
    void testGetOriginalFileInvalidManifest() {
        ...
        var originalFile = AsicContainerUtils.getOriginalDocuments(asiceWithInvalidManifestFile).get(0);
    ...
    void testGetOriginalFileNoMainfest() {
        ...
        var originalFile = AsicContainerUtils.getOriginalDocuments(asiceWithoutManifestFile).get(0);
    ...
    void testGetOriginalFileManifestFileEntriesNoAttributes() {
        ...
        var originalFile = AsicContainerUtils.getOriginalDocuments(asiceWithManifestFileWithNoFileEntryAttributes).get(0);
    ...
    void testGetOriginalFileMultipleFilesInAsice() {
        ...
        Assertions.assertDoesNotThrow(() -> AsicContainerUtils.getOriginalDocuments(asiceWithMultipleFiles));
    }

    @Test
    void testGetOriginalFilesMultipleFilesInAsice() {
        var asiceWithMultipleFiles = createAsiceWithMultipleFiles();

        var originalDocuments = AsicContainerUtils.getOriginalDocuments(asiceWithMultipleFiles);

        Assertions.assertEquals(2, originalDocuments.size());
        Assertions.assertEquals("test.txt", originalDocuments.get(0).getName());
        Assertions.assertEquals("test2.txt", originalDocuments.get(1).getName());
    }
