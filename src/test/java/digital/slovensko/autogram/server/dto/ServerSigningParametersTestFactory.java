...
final class ServerSigningParametersTestFactory {
    ...
    static ServerSigningParameters create(
            ...
            VersionedSigningParameters.LocalCanonicalizationMethod infoCanonicalization,
            VersionedSigningParameters.LocalCanonicalizationMethod propertiesCanonicalization,
            VersionedSigningParameters.LocalCanonicalizationMethod keyInfoCanonicalization,
            String schema, String transformation, String identifier, boolean checkPDFACompliance,
            PresentationParameters.VisualizationWidthEnum visualizationWidth, Boolean autoLoadEform,
            boolean embedUsedSchemas, String schemaIdentifier, String transformationIdentifier,
            String transformationLanguage,
            XDCParameters.TransformationOutputMimeType transformationMediaDestinationTypeDescription,
