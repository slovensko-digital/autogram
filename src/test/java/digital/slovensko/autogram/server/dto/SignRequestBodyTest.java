...
class SignRequestBodyTest {
    ...
    void testValidateXDCWithoutXSD() throws IOException {
        ...
        var document = new Document("document.xml", xmlContent);
    ...
    void testValidateXDCWithInvalidXmlAgainstXSD() throws IOException {
        ...
        Assertions.assertThrows(XMLValidationException.class, () -> {signRequestBody.getParameters(true);});
    }
    ...
    void testValidateXDCEmptyXSLT() {
        ...
        Assertions.assertThrows(TransformationParsingErrorException.class, () -> {signRequestBody.getParameters(true);});
    }
    ...
    void testValidateXDCBase64InvalidXSD() {
        ...
        Assertions.assertThrows(MalformedBodyException.class, () -> {signRequestBody.getParameters(true);});
    }
