...
import digital.slovensko.autogram.core.visualization.FailedVisualization;
...
public class SigningParametersTests {
        ...
        void testInvalidTransformation() {
                ...
                if (v instanceof FailedVisualization fvd) {
                        assertEquals(fvd.getError().getClass(), SAXParseException.class);
                }
        }
}
